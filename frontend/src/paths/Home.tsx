    ...
    <div className=" h-full  overflow-hidden flex flex-col ">
      ...
      <div className="w-full h-full  relative flex">
        <video
          ...
          loop
          muted
          className="absolute pointer-events-none top-0 left-0 min-w-full w-full min-h-full  object-cover -z-10"
        >
          <source src={backvid} type="video/mp4" />
        </video>

        <div className="absolute inset-0 h-full bg-black bg-opacity-50 -z-10"></div>
       

        <main className="flex flex-1 items-center   justify-center text-white ">
          <div className="w-[600px] h-[600px]  backdrop-blur-lg items-center p-5 text-center justify-center flex flex-col gap-10 relative rounded-full ">
